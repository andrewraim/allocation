...
abstract: |
  In survey sampling, units in the population can be partitioned into
  predetermined strata. The designer of the survey must determine the number of
  units to sample from each strata. The `allocation` package implements several
  algorithms from @Wright2012 and @Wright2017 which reconsider Neyman's classic
  method of allocating a sample into such strata [@Neyman1934].
thanks: |
...
**TBD:** Describe the rest of the vignette.
