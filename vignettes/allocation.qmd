...
abstract: |
  When sampling from a finite population, the $N$ units are often partitioned into
  ...
  reconsider Neyman's classic method of allocating a given sample size $n$ among such
